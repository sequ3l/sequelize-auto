    ...
    makeHeaderTemplate() {
        ...
        if (this.options.lang === 'ts') {
            ...
            header += !((_c = this.options.firestrap) === null || _c === void 0 ? void 0 : _c.moduleExports)
                ...
                : `module.exports = (${(_d = this.options.firestrap) === null || _d === void 0 ? void 0 : _d.moduleExports}) => class initialize {\n`;
            header += sp + `static #models = ${(_e = this.options.firestrap) === null || _e === void 0 ? void 0 : _e.connectionAlias}\n\nstatic async spark () => ${(_g = (_f = this.options.firestrap) === null || _f === void 0 ? void 0 : _f.connectionAlias) !== null && _g !== void 0 ? _g : 'sequelize'}.define('#TABLE#', {\n`;
        }
        return header;
    }
    generateText() {
