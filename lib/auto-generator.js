...
class AutoGenerator {
    ...
    makeHeaderTemplate() {
        ...
        if (this.options.lang === 'ts') {
            ...
            header += ((_b = (_a = this.options.cjsConfiguration) === null || _a === void 0 ? void 0 : _a.importSequelize) !== null && _b !== void 0 ? _b : true)
                ? "const Sequelize = require('sequelize');\n"
                : '';
            header += !((_c = this.options.cjsConfiguration) === null || _c === void 0 ? void 0 : _c.moduleExports)
                ? `module.exports = function(sequelize, DataTypes) {\n`
                : `module.exports = (${(_d = this.options.cjsConfiguration) === null || _d === void 0 ? void 0 : _d.moduleExports}) => {\n`;
            header += sp + `return () => ${(_f = (_e = this.options.cjsConfiguration) === null || _e === void 0 ? void 0 : _e.connectionAlias) !== null && _f !== void 0 ? _f : 'sequelize'}.define('#TABLE#', {\n`;
        }
        return header;
    }
    generateText() {
            ...
            if (attr === "foreignKey") {
                ...
                if (lodash_1.default.isString(defaultVal)) {
                    ...
                    if (field_type === 'bit(1)' || field_type === 'bit' || field_type === 'boolean') {
                        ...
                        val_text = ((_a = this.options.cjsConfiguration) === null || _a === void 0 ? void 0 : _a.sequelizeAlias) ? `${(_b = this.options.cjsConfiguration) === null || _b === void 0 ? void 0 : _b.sequelizeAlias}.DataTypes.UUIDV` : "DataTypes.UUIDV4";
                    }
                    else if (defaultVal.match(/\w+\(\)$/)) {
                        // replace db function with sequelize function
                        val_text = ((_c = this.options.cjsConfiguration) === null || _c === void 0 ? void 0 : _c.sequelizeAlias) ? `${(_d = this.options.cjsConfiguration) === null || _d === void 0 ? void 0 : _d.sequelizeAlias}.fn('` + defaultVal.replace(/\(\)$/g, "") + "')" : "Sequelize.Sequelize.fn('" + defaultVal.replace(/\(\)$/g, "") + "')";
                    }
                    else if (this.isNumber(field_type)) {
                        if (defaultVal.match(/\(\)/g)) {
                            // assume it's a server function if it contains parens
                            val_text = ((_e = this.options.cjsConfiguration) === null || _e === void 0 ? void 0 : _e.sequelizeAlias) ? `${(_f = this.options.cjsConfiguration) === null || _f === void 0 ? void 0 : _f.sequelizeAlias}.Sequelize.literal('` + defaultVal + "')" : "Sequelize.Sequelize.literal('" + defaultVal + "')";
                        }
                        else {
                            // don't quote numbers
                            val_text = defaultVal;
                        ...
                        val_text = ((_g = this.options.cjsConfiguration) === null || _g === void 0 ? void 0 : _g.sequelizeAlias) ? `${(_h = this.options.cjsConfiguration) === null || _h === void 0 ? void 0 : _h.sequelizeAlias}.Sequelize.literal('` + defaultVal + "')" : "Sequelize.Sequelize.literal('" + defaultVal + "')";
                    }
                        ...
                        if (lodash_1.default.includes(['current_timestamp', 'current_date', 'current_time', 'localtime', 'localtimestamp'], defaultVal.toLowerCase())) {
                            val_text = ((_j = this.options.cjsConfiguration) === null || _j === void 0 ? void 0 : _j.sequelizeAlias) ? `${(_k = this.options.cjsConfiguration) === null || _k === void 0 ? void 0 : _k.sequelizeAlias}.Sequelize.literal('` + defaultVal + "')" : "Sequelize.Sequelize.literal('" + defaultVal + "')";
                        }
                        else {
    ...
    getSqType(fieldObj, attr) {
        ...
        if (type === "boolean" || type === "bit(1)" || type === "bit" || type === "tinyint(1)") {
            val = ((_a = this.options.cjsConfiguration) === null || _a === void 0 ? void 0 : _a.sequelizeAlias) ? `${(_b = this.options.cjsConfiguration) === null || _b === void 0 ? void 0 : _b.sequelizeAlias}.DataTypes.BOOLEAN` : 'DataTypes.BOOLEAN';
            // postgres range types
        }
        else if (type === "numrange") {
            val = ((_c = this.options.cjsConfiguration) === null || _c === void 0 ? void 0 : _c.sequelizeAlias) ? `${(_d = this.options.cjsConfiguration) === null || _d === void 0 ? void 0 : _d.sequelizeAlias}.DataTypes.RANGE(DataTypes.DECIMAL)` : 'DataTypes.RANGE(DataTypes.DECIMAL)';
        }
        else if (type === "int4range") {
            val = ((_e = this.options.cjsConfiguration) === null || _e === void 0 ? void 0 : _e.sequelizeAlias) ? `${(_f = this.options.cjsConfiguration) === null || _f === void 0 ? void 0 : _f.sequelizeAlias}.DataTypes.RANGE(DataTypes.INTEGER)` : 'DataTypes.RANGE(DataTypes.INTEGER)';
        }
        else if (type === "int8range") {
            val = ((_g = this.options.cjsConfiguration) === null || _g === void 0 ? void 0 : _g.sequelizeAlias) ? `${(_h = this.options.cjsConfiguration) === null || _h === void 0 ? void 0 : _h.sequelizeAlias}.DataTypes.RANGE(DataTypes.BIGINT)` : 'DataTypes.RANGE(DataTypes.BIGINT)';
        }
        else if (type === "daterange") {
            val = ((_j = this.options.cjsConfiguration) === null || _j === void 0 ? void 0 : _j.sequelizeAlias) ? `${(_k = this.options.cjsConfiguration) === null || _k === void 0 ? void 0 : _k.sequelizeAlias}.DataTypes.RANGE(DataTypes.DATEONLY)` : 'DataTypes.RANGE(DataTypes.DATEONLY)';
        }
        else if (type === "tsrange" || type === "tstzrange") {
            val = ((_l = this.options.cjsConfiguration) === null || _l === void 0 ? void 0 : _l.sequelizeAlias) ? `${(_m = this.options.cjsConfiguration) === null || _m === void 0 ? void 0 : _m.sequelizeAlias}.DataTypes.RANGE(DataTypes.DATE)` : 'DataTypes.RANGE(DataTypes.DATE)';
        }
        else if (typematch = type.match(/^(bigint|smallint|mediumint|tinyint|int)/)) {
            // integer subtypes
            val = ((_o = this.options.cjsConfiguration) === null || _o === void 0 ? void 0 : _o.sequelizeAlias) ? `${(_p = this.options.cjsConfiguration) === null || _p === void 0 ? void 0 : _p.sequelizeAlias}.DataTypes.` + (typematch[0] === 'int' ? 'INTEGER' : typematch[0].toUpperCase()) : 'DataTypes.' + (typematch[0] === 'int' ? 'INTEGER' : typematch[0].toUpperCase());
            ...
            val = ((_q = this.options.cjsConfiguration) === null || _q === void 0 ? void 0 : _q.sequelizeAlias) ? `${(_r = this.options.cjsConfiguration) === null || _r === void 0 ? void 0 : _r.sequelizeAlias}.DataTypes.TEXT` : 'DataTypes.TEXT';
        }
        else if (type.match(/n?varchar|string|varying/)) {
            val = ((_s = this.options.cjsConfiguration) === null || _s === void 0 ? void 0 : _s.sequelizeAlias) ? `${(_t = this.options.cjsConfiguration) === null || _t === void 0 ? void 0 : _t.sequelizeAlias}.DataTypes.STRING` + (!lodash_1.default.isNull(length) ? length : '') : 'DataTypes.STRING' + (!lodash_1.default.isNull(length) ? length : '');
        }
        else if (type.match(/^n?char/)) {
            val = ((_u = this.options.cjsConfiguration) === null || _u === void 0 ? void 0 : _u.sequelizeAlias) ? `${(_v = this.options.cjsConfiguration) === null || _v === void 0 ? void 0 : _v.sequelizeAlias}.DataTypes.CHAR` + (!lodash_1.default.isNull(length) ? length : '') : 'DataTypes.CHAR' + (!lodash_1.default.isNull(length) ? length : '');
        }
        else if (type.match(/^real/)) {
            val = ((_w = this.options.cjsConfiguration) === null || _w === void 0 ? void 0 : _w.sequelizeAlias) ? `${(_x = this.options.cjsConfiguration) === null || _x === void 0 ? void 0 : _x.sequelizeAlias}.DataTypes.REAL` : 'DataTypes.REAL';
        }
        else if (type.match(/text$/)) {
            val = ((_y = this.options.cjsConfiguration) === null || _y === void 0 ? void 0 : _y.sequelizeAlias) ? `${(_z = this.options.cjsConfiguration) === null || _z === void 0 ? void 0 : _z.sequelizeAlias}.DataTypes.TEXT` + (!lodash_1.default.isNull(length) ? length : '') : 'DataTypes.TEXT' + (!lodash_1.default.isNull(length) ? length : '');
        }
        else if (type === "date") {
            val = ((_0 = this.options.cjsConfiguration) === null || _0 === void 0 ? void 0 : _0.sequelizeAlias) ? `${(_1 = this.options.cjsConfiguration) === null || _1 === void 0 ? void 0 : _1.sequelizeAlias}.DataTypes.DATEONLY` : 'DataTypes.DATEONLY';
        }
        else if (type.match(/^(date|timestamp|year)/)) {
            val = ((_2 = this.options.cjsConfiguration) === null || _2 === void 0 ? void 0 : _2.sequelizeAlias) ? `${(_3 = this.options.cjsConfiguration) === null || _3 === void 0 ? void 0 : _3.sequelizeAlias}.DataTypes.DATE` + (!lodash_1.default.isNull(length) ? length : '') : 'DataTypes.DATE' + (!lodash_1.default.isNull(length) ? length : '');
        }
        else if (type.match(/^(time)/)) {
            val = ((_4 = this.options.cjsConfiguration) === null || _4 === void 0 ? void 0 : _4.sequelizeAlias) ? `${(_5 = this.options.cjsConfiguration) === null || _5 === void 0 ? void 0 : _5.sequelizeAlias}.DataTypes.TIME` : 'DataTypes.TIME';
        }
        else if (type.match(/^(float|float4)/)) {
            val = ((_6 = this.options.cjsConfiguration) === null || _6 === void 0 ? void 0 : _6.sequelizeAlias) ? `${(_7 = this.options.cjsConfiguration) === null || _7 === void 0 ? void 0 : _7.sequelizeAlias}.DataTypes.FLOAT` + (!lodash_1.default.isNull(precision) ? precision : '') : 'DataTypes.FLOAT' + (!lodash_1.default.isNull(precision) ? precision : '');
        }
        else if (type.match(/^(decimal|numeric)/)) {
            val = ((_8 = this.options.cjsConfiguration) === null || _8 === void 0 ? void 0 : _8.sequelizeAlias) ? `${(_9 = this.options.cjsConfiguration) === null || _9 === void 0 ? void 0 : _9.sequelizeAlias}.DataTypes.DECIMAL` + (!lodash_1.default.isNull(precision) ? precision : '') : 'DataTypes.DECIMAL' + (!lodash_1.default.isNull(precision) ? precision : '');
        }
        else if (type.match(/^money/)) {
            val = ((_10 = this.options.cjsConfiguration) === null || _10 === void 0 ? void 0 : _10.sequelizeAlias) ? `${(_11 = this.options.cjsConfiguration) === null || _11 === void 0 ? void 0 : _11.sequelizeAlias}.DataTypes.DECIMAL(19,4)` : 'DataTypes.DECIMAL(19,4)';
        }
        else if (type.match(/^smallmoney/)) {
            val = ((_12 = this.options.cjsConfiguration) === null || _12 === void 0 ? void 0 : _12.sequelizeAlias) ? `${(_13 = this.options.cjsConfiguration) === null || _13 === void 0 ? void 0 : _13.sequelizeAlias}.DataTypes..DECIMAL(10,4)` : 'DataTypes.DECIMAL(10,4)';
        }
        else if (type.match(/^(float8|double)/)) {
            val = ((_14 = this.options.cjsConfiguration) === null || _14 === void 0 ? void 0 : _14.sequelizeAlias) ? `${(_15 = this.options.cjsConfiguration) === null || _15 === void 0 ? void 0 : _15.sequelizeAlias}.DataTypes.DOUBLE` + (!lodash_1.default.isNull(precision) ? precision : '') : 'DataTypes.DOUBLE' + (!lodash_1.default.isNull(precision) ? precision : '');
        }
        else if (type.match(/^uuid|uniqueidentifier/)) {
            val = ((_16 = this.options.cjsConfiguration) === null || _16 === void 0 ? void 0 : _16.sequelizeAlias) ? `${(_17 = this.options.cjsConfiguration) === null || _17 === void 0 ? void 0 : _17.sequelizeAlias}.DataTypes.UUID` : 'DataTypes.UUID';
        }
        else if (type.match(/^jsonb/)) {
            val = ((_18 = this.options.cjsConfiguration) === null || _18 === void 0 ? void 0 : _18.sequelizeAlias) ? `${(_19 = this.options.cjsConfiguration) === null || _19 === void 0 ? void 0 : _19.sequelizeAlias}.DataTypes.JSONB` : 'DataTypes.JSONB';
        }
        else if (type.match(/^json/)) {
            val = ((_20 = this.options.cjsConfiguration) === null || _20 === void 0 ? void 0 : _20.sequelizeAlias) ? `${(_21 = this.options.cjsConfiguration) === null || _21 === void 0 ? void 0 : _21.sequelizeAlias}.DataTypes.JSON` : 'DataTypes.JSON';
        }
        else if (type.match(/^geometry/)) {
            const gtype = fieldObj.elementType ? `(${fieldObj.elementType})` : '';
            val = ((_22 = this.options.cjsConfiguration) === null || _22 === void 0 ? void 0 : _22.sequelizeAlias) ? `${(_23 = this.options.cjsConfiguration) === null || _23 === void 0 ? void 0 : _23.sequelizeAlias}.DataTypes.GEOMETRY${gtype}` : `DataTypes.GEOMETRY${gtype}`;
        }
        else if (type.match(/^geography/)) {
            const gtype = fieldObj.elementType ? `(${fieldObj.elementType})` : '';
            val = ((_24 = this.options.cjsConfiguration) === null || _24 === void 0 ? void 0 : _24.sequelizeAlias) ? `${(_25 = this.options.cjsConfiguration) === null || _25 === void 0 ? void 0 : _25.sequelizeAlias}.DataTypes.GEOGRAPHY${gtype}` : `DataTypes.GEOGRAPHY${gtype}`;
        }
        else if (type.match(/^array/)) {
            const eltype = this.getSqType(fieldObj, "elementType");
            val = ((_26 = this.options.cjsConfiguration) === null || _26 === void 0 ? void 0 : _26.sequelizeAlias) ? `${(_27 = this.options.cjsConfiguration) === null || _27 === void 0 ? void 0 : _27.sequelizeAlias}.DataTypes.ARRAY(${eltype})` : `DataTypes.ARRAY(${eltype})`;
        }
        else if (type.match(/(binary|image|blob|bytea)/)) {
            val = ((_28 = this.options.cjsConfiguration) === null || _28 === void 0 ? void 0 : _28.sequelizeAlias) ? `${(_29 = this.options.cjsConfiguration) === null || _29 === void 0 ? void 0 : _29.sequelizeAlias}.DataTypes.BLOB` : 'DataTypes.BLOB';
        }
        else if (type.match(/^hstore/)) {
            val = ((_30 = this.options.cjsConfiguration) === null || _30 === void 0 ? void 0 : _30.sequelizeAlias) ? `${(_31 = this.options.cjsConfiguration) === null || _31 === void 0 ? void 0 : _31.sequelizeAlias}.DataTypes.HSTORE` : 'DataTypes.HSTORE';
        }
        else if (type.match(/^inet/)) {
            val = ((_32 = this.options.cjsConfiguration) === null || _32 === void 0 ? void 0 : _32.sequelizeAlias) ? `${(_33 = this.options.cjsConfiguration) === null || _33 === void 0 ? void 0 : _33.sequelizeAlias}.DataTypes.INET` : 'DataTypes.INET';
        }
        else if (type.match(/^cidr/)) {
            val = ((_34 = this.options.cjsConfiguration) === null || _34 === void 0 ? void 0 : _34.sequelizeAlias) ? `${(_35 = this.options.cjsConfiguration) === null || _35 === void 0 ? void 0 : _35.sequelizeAlias}.DataTypes.CIDR` : 'DataTypes.CIDR';
        }
        else if (type.match(/^oid/)) {
            val = ((_36 = this.options.cjsConfiguration) === null || _36 === void 0 ? void 0 : _36.sequelizeAlias) ? `${(_37 = this.options.cjsConfiguration) === null || _37 === void 0 ? void 0 : _37.sequelizeAlias}.DataTypes.INTEGER` : 'DataTypes.INTEGER';
        }
        else if (type.match(/^macaddr/)) {
            val = ((_38 = this.options.cjsConfiguration) === null || _38 === void 0 ? void 0 : _38.sequelizeAlias) ? `${(_39 = this.options.cjsConfiguration) === null || _39 === void 0 ? void 0 : _39.sequelizeAlias}.DataTypes.MACADDR` : 'DataTypes.MACADDR';
        }
        else if (type.match(/^enum(\(.*\))?$/)) {
            const enumValues = this.getEnumValues(fieldObj);
            val = ((_40 = this.options.cjsConfiguration) === null || _40 === void 0 ? void 0 : _40.sequelizeAlias) ? `${(_41 = this.options.cjsConfiguration) === null || _41 === void 0 ? void 0 : _41.sequelizeAlias}.DataTypes.ENUM(${enumValues}` : `DataTypes.ENUM(${enumValues})`;
        }
        return val;
    }
