...
class AutoWriter {
    ...
    createAssociations(typeScript) {
        ...
        rels.forEach(rel => {
            ...
            if (rel.isM2M) {
                ...
                strBelongs += !((_b = this.options.cjsConfiguration) === null || _b === void 0 ? void 0 : _b.modelAlias)
                ...
                strBelongs += !((_c = this.options.cjsConfiguration) === null || _c === void 0 ? void 0 : _c.modelAlias)
    ...
    createES5InitString(tables, assoc, vardef) {
        ...
        if ((_b = this.options.cjsConfiguration) === null || _b === void 0 ? void 0 : _b.moduleExports) {
            ...
            str += `\tstatic #data = ${(_c = this.options.cjsConfiguration) === null || _c === void 0 ? void 0 : _c.modelAlias}\n\n`;
        ...
        // add the asociations
        str += "\n" + assoc;
        if (!((_d = this.options.cjsConfiguration) === null || _d === void 0 ? void 0 : _d.ignoreWriterImports)) {
            // return the models
            str += `\n${sp}return {\n`;
            modelNames.forEach(m => {
                str += `${this.space[2]}${m},\n`;
