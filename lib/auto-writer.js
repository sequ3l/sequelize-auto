...
class AutoWriter {
    ...
    write() {
        ...
        if ((_a = this.options.firestrap) === null || _a === void 0 ? void 0 : _a.initPath) {
            this.options.firestrap.initPath = path_1.default.join(this.options.directory, this.options.firestrap.initPath);
        ...
        if (!this.options.noInitModels) {
            ...
            const initFilePath = !((_b = this.options.firestrap) === null || _b === void 0 ? void 0 : _b.initPath)
                ? path_1.default.join(this.options.directory, "init-models" + (isTypeScript ? '.ts' : '.js'))
                : path_1.default.join(this.options.firestrap.initPath, "initialize" + (isTypeScript ? '.ts' : '.js'));
    ...
    createAssociations(typeScript) {
        ...
        rels.forEach(rel => {
            ...
            if (rel.isM2M) {
                ...
                strBelongsToMany += !((_a = this.options.firestrap) === null || _a === void 0 ? void 0 : _a.modelAlias)
                    ...
                    : `\t\t${(_b = this.options.firestrap) === null || _b === void 0 ? void 0 : _b.modelAlias}${dot}${rel.parentModel}.belongsToMany(${(_c = this.options.firestrap) === null || _c === void 0 ? void 0 : _c.modelAlias}${dot}${rel.childModel}, { as: '${asprop}', through: ${(_d = this.options.firestrap) === null || _d === void 0 ? void 0 : _d.modelAlias}${dot}${rel.joinModel}, foreignKey: "${rel.parentId}", otherKey: "${rel.childId}" });\n`;
            }
            else {
                ...
                strBelongs += !((_e = this.options.firestrap) === null || _e === void 0 ? void 0 : _e.modelAlias)
                    ? `${sp}${rel.childModel}.belongsTo(${rel.parentModel}, { ${bAlias}foreignKey: "${rel.parentId}"});\n`
                    : `\t\t${(_f = this.options.firestrap) === null || _f === void 0 ? void 0 : _f.modelAlias}${dot}${rel.childModel}.belongsTo(${(_g = this.options.firestrap) === null || _g === void 0 ? void 0 : _g.modelAlias}${dot}${rel.parentModel}, { ${bAlias}foreignKey: "${rel.parentId}" });\n`;
                ...
                strBelongs += !((_h = this.options.firestrap) === null || _h === void 0 ? void 0 : _h.modelAlias)
                    ? `${sp}${rel.parentModel}.${hasRel}(${rel.childModel}, { ${hAlias}foreignKey: "${rel.parentId}"});\n`
                    : `\t\t${(_j = this.options.firestrap) === null || _j === void 0 ? void 0 : _j.modelAlias}${dot}${rel.parentModel}.${hasRel}(${(_k = this.options.firestrap) === null || _k === void 0 ? void 0 : _k.modelAlias}${dot}${rel.childModel}, { ${hAlias}foreignKey: "${rel.parentId}" });\n`;
            }
        });
    ...
    createES5InitString(tables, assoc, vardef) {
        var _a, _b, _c;
        let str = '';
        str = !((_a = this.options.firestrap) === null || _a === void 0 ? void 0 : _a.ignoreWriterImports)
        ...
        if ((_b = this.options.firestrap) === null || _b === void 0 ? void 0 : _b.moduleExports) {
            // create the initialization function
        ...
        // add the asociations
        str += "\n" + assoc;
        if (!((_c = this.options.firestrap) === null || _c === void 0 ? void 0 : _c.ignoreWriterImports)) {
            // return the models
            str += `\n${sp}return {\n`;
            modelNames.forEach(m => {
                str += `${this.space[2]}${m},\n`;
